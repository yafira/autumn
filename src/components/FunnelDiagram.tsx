        ...
        >
          <g fontFamily="Inter, sans-serif">
            <rect
              ...
              height="48"
              rx="6"
              fill="rgba(248,236,217,0.08)"
              stroke="rgba(248,236,217,0.35)"
            />
            <text
              x="85"
              y="115"
            ...
            <rect
              ...
              height="48"
              rx="6"
              fill="rgba(204,91,44,0.18)"
              stroke="rgba(204,91,44,0.6)"
            />
            <text
              x="430"
              y="55"
            ...
            <rect
              ...
              height="48"
              rx="6"
              fill="rgba(248,236,217,0.1)"
              stroke="rgba(248,236,217,0.4)"
            />
            <text
              x="790"
              y="49"
            ...
            <rect
              ...
              height="48"
              rx="6"
              fill="rgba(248,236,217,0.05)"
              stroke="rgba(248,236,217,0.2)"
            />
            <text
              x="430"
              y="175"
              fill="rgba(248,236,217,0.7)"
              fontSize="14"
              textAnchor="middle"
            >
              OTA listing
            ...
            <text
              x="790"
              y="185"
              fill="rgba(248,236,217,0.45)"
              fontSize="12"
              textAnchor="middle"
            >
              OTA keeps the commission
            </text>

            <path
              d="M160 105 C 240 105, 240 50, 340 50"
              fill="none"
              stroke="rgba(204,91,44,0.5)"
              strokeWidth="2"
            />
            <motion.path
              d="M160 105 C 240 105, 240 50, 340 50"
